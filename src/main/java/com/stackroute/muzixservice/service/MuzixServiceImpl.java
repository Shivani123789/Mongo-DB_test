...
public class MuzixServiceImpl implements MuzixService {
    ...
    public Muzix saveTrack(Muzix muzix)throws TrackAlreadyExistsException {
        ...
        Muzix savedMuzix = (Muzix) muzixRepository.save(muzix);
        return savedMuzix;
    }
// save tack method is closed
    ...
    @Override
    public Muzix displayTrackById(int trackId) throws TrackNotFoundException
    {
        Muzix muzix1=null;
        Optional optional=muzixRepository.findById(trackId);
        if(optional.isPresent())
        {
            muzix1= (Muzix) muzixRepository.findById(trackId).get();
